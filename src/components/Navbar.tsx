...
const Header = () => {
  ...
  return (
    <header className="w-full border-b border-gray-300 bg-gray-50">
      ...
      {/* Main Section */}
      <div className="container flex justify-between items-center w-full h-24 mx-auto px-4 lg:px-6">
        {/* Logo */}
        <div className="flex items-center">
          <Image src="/c.png" alt="Logo" width={180} height={180} />
        </div>

        {/* Contact Details */}
        <div className="hidden lg:flex  items-center justify-between space-x-6 text-gray-600 text-sm">
          <div className="flex items-center space-x-2">
            <FiPhone className="hover:text-orange-500 text-2xl" />
            <div className="flex flex-col">
              <span className="text-gray-400 uppercase text-xs">CALL US</span>
              <span className="text-orange-500 font-semibold lg:text-[12px]">+971 6 573 5969</span>
            </div>
          </div>
          <div className="flex items-center space-x-2">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-orange-500 font-semibold lg:text-[12px]">sales@babalkhibrah.com</span>
            </div>
          </div>
          <div className="flex items-center space-x-2">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-orange-500 font-semibold lg:text-[12px]">Sat - Thurs, 8AM to 6PM</span>
            </div>
          </div>
        </div>
        ...
        <button
          title="Menu"
          className="lg:hidden text-orange-500 text-2xl"
      ...
      {/* Mobile View */}
      <div className={`flex flex-wrap justify-center items-center gap-x-4 gap-y-2 text-gray-600 text-sm lg:hidden py-3`}>
      ...
      <nav className="bg-white border-t border-gray-200">
        <div className="container mx-auto flex justify-between items-center lg:justify-center space-x-6 py-3 text-gray-700 font-medium  px-4 lg:px-6 text-[13px]">
          {/* Menu */}
          <div
            className={`${
              isMenuOpen ? "block" : "hidden"
            } absolute right-0 bg-white w-full z-10 p-4 lg:relative lg:flex lg:w-auto lg:p-0`}
          >
